...
if [ ! -x cargo ]; then
    ...
    if [[ $arch == x86_64-apple-darwin* ]]; then
        curl -o cargo https://repo.typedb.com/public/public-infrastructure/raw/versions/1.66.0_darwin_x86_64/cargo
    elif [[ $arch == arm64-apple-darwin* ]]; then
        curl -o cargo https://repo.typedb.com/public/public-infrastructure/raw/versions/1.66.0_darwin_arm64/cargo
    else
