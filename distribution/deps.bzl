...
#    ) # TODO: Reference /vaticle after the PR is merged.
    git_repository(
        ...
        commit = "36a5e5dfd82f0c7a70b544ad23d5731ee599c762" # sync-marker: do not remove this comment, this is used for sync-dependencies by @vaticle_bazel_distribution
    )
#
