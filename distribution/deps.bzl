...
#    ) # TODO: Reference /vaticle after the PR is merged.
    git_repository(
        ...
        commit = "30331891a4ba7a49af75e8a095ae5f0804d2fdb5" # sync-marker: do not remove this comment, this is used for sync-dependencies by @vaticle_bazel_distribution
    )
