...
#    ) # TODO: Reference /vaticle after the PR is merged.
    git_repository(
        ...
        commit = "b43e2407187e31ecf3bf1f64396a1640d1b27946" # sync-marker: do not remove this comment, this is used for sync-dependencies by @vaticle_bazel_distribution
    )
