...
#    ) # TODO: Reference /vaticle after the PR is merged.
    git_repository(
        ...
        commit = "6888571f433ff4e91bb6296bd632c7abb706bdd2" # sync-marker: do not remove this comment, this is used for sync-dependencies by @vaticle_bazel_distribution
    )
